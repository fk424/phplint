 ...
 * @version $Date: 2014/08/17 13:55:40 $
 */
...
//					return NULL;
	...
	/**
	 * Returns true if the current context is a class non-static context.
	 * That is, true if we are currently parsing a non-static method,
	 * false in any other case.
	 * @return boolean True if we are parsing a non-static method.
	 */
	public function isNonStaticContext()
	{
		$pkg = $this->curr_pkg;
		return $pkg->curr_class !== NULL
