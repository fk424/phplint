...
/**
	...
	@version $Date: 2014/08/13 18:42:57 $
*/
class Types {
	...
	/**
		Parses a type descriptor an retrieves a type object that corrensponds to
		it. The object result of this compilation implements the {@link
		it\icosaedro\phplint\TypeInterface} interface, and then provides the check() method that
