 ...
 * any actual access to the underliyng file system, and keeps manipulating only
 * simple strings in memory. Access to the underliyng file system may throw
 ...
 * constructor telling the directory agaist which the relative path must be
 * resolved.
 * Example:
 * 
 * <pre>
 ...
 * the underliyng file system, as several restriction may forbid some other
 * characters, may set a maximun length to the path, or may contain
 * directories that does not exist or are not accessible.
 *
 * @author Umberto Salsi <salsi@icosaedro.it>
 * @version $Date: 2014/10/27 20:50:12 $
 */
class File implements Printable, UPrintable, Sortable, Hashable {
	 ...
	 * A volume name is the unit drive letter (exmaple: "C:") or the UNC host
	 ...
	 * missing drive letter. If NULL, may thorw exception.
	 ...
	 * the file whould result to be "." or "..".
	 * Examples:
	 * <blockquote><pre>
